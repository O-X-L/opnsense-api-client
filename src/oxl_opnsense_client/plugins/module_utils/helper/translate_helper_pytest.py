...
def test_get_selected():
    from plugins.module_utils.helper.translate import get_selected


def test_get_selected_value():
    from plugins.module_utils.helper.translate import get_selected_value


def test_get_selected_opt_list():
    from plugins.module_utils.helper.translate import get_selected_opt_list


def test_get_selected_opt_list_idx():
    from plugins.module_utils.helper.translate import get_selected_opt_list_idx


def test_get_selected_multi():
    from plugins.module_utils.helper.translate import get_selected_multi


def test_get_selected_list():
    from plugins.module_utils.helper.translate import get_selected_list
...
def test_simplify_translate(existing, translate, simple):
    from plugins.module_utils.helper.translate import simplify_translate
...
def test_ensure_field_value_typing_external_helpers(mocker):
    ...
    mock_is_true = mocker.patch(
        'plugins.module_utils.helper.translate.is_true',
        return_value=True,
    )
    mock_format_int = mocker.patch(
        'plugins.module_utils.helper.translate.format_int',
        return_value=443,
    )
...
def test_translate_orchestrator_error_handling(mocker):
    ...
    mock_exit_bug = mocker.patch('plugins.module_utils.helper.translate.exit_bug')
