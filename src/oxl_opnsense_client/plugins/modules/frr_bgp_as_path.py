...
try:
    ...
    from ansible_collections.oxlorg.opnsense.plugins.module_utils.main.frr_bgp_as_path import AsPath

except MODULE_EXCEPTIONS:
    module_dependency_error()


# DOCUMENTATION = 'https://ansible-opnsense.oxl.app/modules/frr_bgp.html#oxlorg-opnsense-frr-bgp-as-path'
# EXAMPLES = 'https://ansible-opnsense.oxl.app/modules/frr_bgp.html#id6'
