...
try:
    ...
    from ansible_collections.oxlorg.opnsense.plugins.module_utils.main.frr_ospf3_network import Network
...
def run_module():
    module_args = dict(
        ...
        area_range=dict(
            type='str', required=False,
            description='Here you can summarize a network for this area like fe80:1234::/56'
        ),
        prefix_list_in=dict(
