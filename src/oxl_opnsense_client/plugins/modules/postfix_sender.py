...
try:
    ...
    from plugins.module_utils.main.postfix_sender import Sender
...
def run_module():
    module_args = dict(
        address=dict(
            ...
            description='Set the sender address to match.',
        ),
        action=dict(
    ...
    module_wrapper(Sender(module=module, result=result))
